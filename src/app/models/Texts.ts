...
export class Texts{
    ...
    Init(){
        ...
        this.FaTexts["home3"] = "گیم‌کرفت رویداد بازی‌سازی است که با هدف ایجاد انگیزه و تقویت شوق در علاقه‌مندان به طراحی و ساخت بازی، برای دومین بار با میزبانی دانشگاه صنعتی امیرکبیر برگزار می‌شود.<br>رویداد امسال به منظور ایجاد بستری برای انتقال اطلاعات و تجارب افراد خبره در حوزه‌ بازی‌سازی، شبکه‌سازی و تیم‌سازی علاقه‌مندان شامل کارگاه‌های حضوری، ارائه‌ و کارگاه‌های مجازی می‌باشد. پس از آن ساخت و طراحی بازی در قالب یک رقابت آغاز میشود و در انتها از برندگان تقدیر به عمل می‌آید."

        this.FaTexts["home4"] = "7:23:59:2"
        this.FaTexts["home5"] = "تا پایان ثبت‌نام"
        ...
        this.FaTexts["home12"] = "6 فروردین"
        this.FaTexts["home13"] = "داوری"
        this.FaTexts["home14"] = "21 فروردین"
