export class Texts {
  ...
  Init() {
    ...
    this.FaTexts["home2"] = "چهارمین رویداد بازی سازی دانشگاه صنعتی امیرکبیر"
    this.FaTexts["home3"] = "گیم‌کرفت رویداد بازی‌سازی است که با هدف ایجاد انگیزه و تقویت شوق در علاقه‌مندان به طراحی و ساخت بازی، برای چهارمین بار با میزبانی دانشگاه صنعتی امیرکبیر برگزار می‌شود.<br>رویداد امسال به منظور ایجاد بستری برای انتقال اطلاعات و تجارب افراد خبره در حوزه‌ بازی‌سازی، شبکه‌سازی و تیم‌سازی علاقه‌مندان شامل کارگاه‌های حضوری، ارائه‌ می‌شود. پس از آن ساخت و طراحی بازی در قالب یک رقابت آغاز میشود و در انتها، در مراسم اختتامیه، از برندگان تقدیر به عمل می‌آید."

    // this.FaTexts["home4"] = "7:23:59:2"
    // this.FaTexts["home5"] = "تا پایان مسابقه"
    this.FaTexts["home6"] = "2289"
    // this.FaTexts["home7"] = "شرکت کننده"
    this.FaTexts["home8"] = "برنامه زمانی"
    this.FaTexts["home9"] = "ثبت نام"
    this.FaTexts["home10"] = "دوشنبه ۲۶ شهریور"
    this.FaTexts["home11"] = "شروع داوری"
    this.FaTexts["home12"] = "یکشنبه ۲۲ مهر"
    this.FaTexts["home13"] = "اختتامیه"
    this.FaTexts["home14"] = "۲۶ مهر"
    this.FaTexts["home15"] = "کارگاه‌ها و ارائه های حضوری"
    this.FaTexts["home16"] = "کارگاه بازی سازی"
    this.FaTexts["home17"] = "سه شنبه 2 بهمن 99"
    this.FaTexts["home18"] = "مانده"
    ...
    this.FaTexts["home23"] = "ارائه‌دهندگان"
    this.FaTexts["home24"] = "مسعود فراستی"
    this.FaTexts["home25"] = "منتقد درجه یک"
    this.FaTexts["home26"] = "ارائه‌های مجازی"
    ...
    this.FaTexts["home42"] = "تمامی حقوق برای انجمن علمی دانشکده مهندسی کامپیوتر دانشگاه صنعتی امیرکبیر محفوظ می باشد."
    this.FaTexts["home43"] = "جوایز مسابقه"
    this.FaTexts["home44"] = "شرایط مسابقه"
    this.FaTexts["home45"] = "تیم اول"
    this.FaTexts["home46"] = "12 میلیون تومان"
    this.FaTexts["home47"] = "دست اندر کاران"
    this.FaTexts["home48"] = "شرایط مسابقه"
    this.FaTexts["home49"] = "پایان ثبت نام"
    this.FaTexts["home50"] = "جمعه ۳۰ شهریور"
    this.FaTexts["home51"] = "شروع رویداد"
    this.FaTexts["home52"] = "شنبه ۳۱ شهریور"
    this.FaTexts["home53"] = "شروع مسابقه"
    this.FaTexts["home54"] = "شنبه ۱۴ مهر"
    ...
    this.FaTexts["home60"] = "9 میلیون تومان"
    this.FaTexts["home61"] = "6 میلیون تومان"
    this.FaTexts["home62"] = "یکی از رویکردهای مهم انجمن علمی دانشکده، تقویت روحیه‌ی کار تیمی و در مقیاس بزرگ است؛ به طوری که دانشجویان دخیل در رویدادها با کسب این تجربه، زندگی شغلی مؤثرتری داشته باشند. این رویداد نیز مستثنی نبوده و بسیاری از دانشجویان در این مسیر، انجمن علمی را همراهی کردند."
    this.FaTexts["home63"] = "دستیاران"
    ...
    this.FaTexts["dash-event18"] = "ارائه ها"
    ...
    this.FaTexts["dash-media7"] = "کارگاه ها"
    this.FaTexts["dash-media8"] = "file name"
    this.FaTexts["dash-media9"] = "دانلود"
    this.FaTexts["dash-media10"] = "ارائه ها"
    ...
    this.FaTexts["people10"] = "Backend Developer"
    ...
    this.FaTexts["people29"] = "UI/UX Designer"
    ...
    this.FaTexts["people37"] = "فاطمه ولی‌پورپاشا"
    this.FaTexts["people38"] = "مدیر محصول"
