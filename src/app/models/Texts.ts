...
export class Texts{
    ...
    Init(){
        ...
        this.FaTexts["home3"] = "گیم‌کرفت رویداد آنلاین بازی‌سازی است که با هدف ایجاد انگیزه در علاقه‌مندان به طراحی و ساخت بازی از نابلد تا کاربلد، برای دومین بار با میزبانی دانشگاه صنعتی امیرکبیر برگزار می‌شود. در مسیر این رویداد، شرکت‌کنندگان از یادگیری در کارگاه‌های عملی آنلاین و شرکت در ارائه‌ها با حضور افرادی مجرب شروع می‌کنند و در انتها به کمک آموخته‌های خود در قالب یک چالش تیمی با یکدیگر به رقابت می‌پردازند."
